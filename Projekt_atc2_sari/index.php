...
// // </div>';
//     } else {    
    $sql = "INSERT INTO perdorues (emri, mbiemri, email, password)
...
<nav class="navbar navbar-expand-lg  navbar-light p-3">
    <div class="container-fluid">
        <a style="color: rgb(138 214 126);font-weight: 400;" class="navbar-brand fs-3"
           href="./index.php">Pharma<span>cy</span></a>
